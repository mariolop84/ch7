...
public class DataSource {
	...
	public static List<?> AGE = Arrays.asList(Arrays.asList("alice", 28), Arrays.asList("bob", 33),
			Arrays.asList("chris", 40), Arrays.asList("david", 25), Arrays.asList("emily", 25),
			Arrays.asList("george", 31), Arrays.asList("gary", 28), Arrays.asList("kumar", 27),
			Arrays.asList("luanne", 36));

	public static List<?> GENDER = Arrays.asList(Arrays.asList("alice", "f"), Arrays.asList("bob", "m"),
			Arrays.asList("chris", "m"), Arrays.asList("david", "m"), Arrays.asList("emily", "f"),
			Arrays.asList("george", "m"), Arrays.asList("gary", "m"), Arrays.asList("harold", "m"),
			Arrays.asList("luanne", "f"));

	public static List<?> FOLLOWS = Arrays.asList(Arrays.asList("alice", "david"), Arrays.asList("alice", "bob"),
			Arrays.asList("alice", "emily"), Arrays.asList("bob", "david"), Arrays.asList("bob", "george"),
			Arrays.asList("bob", "luanne"), Arrays.asList("david", "alice"), Arrays.asList("david", "luanne"),
			Arrays.asList("emily", "alice"), Arrays.asList("emily", "bob"), Arrays.asList("emily", "george"),
			Arrays.asList("emily", "gary"), Arrays.asList("george", "gary"), Arrays.asList("harold", "bob"),
			Arrays.asList("luanne", "harold"), Arrays.asList("luanne", "gary"));

	public static List<?> INTEGER = Arrays.asList(Arrays.asList(-1), Arrays.asList(0), Arrays.asList(1),
			Arrays.asList(2), Arrays.asList(3), Arrays.asList(4), Arrays.asList(5), Arrays.asList(6), Arrays.asList(7),
			Arrays.asList(8), Arrays.asList(9));

	public static List<?> VAL1 = Arrays.asList(Arrays.asList("a", 1), Arrays.asList("b", 2), Arrays.asList("c", 5),
			Arrays.asList("d", 12), Arrays.asList("d", 1));

	public static List<?> VAL2 = Arrays.asList(Arrays.asList("b", 4), Arrays.asList("b", 6), Arrays.asList("c", 3),
			Arrays.asList("d", 15));

	public static List<?> TRIPLETS = Arrays.asList(Arrays.asList(1, 2, 3), Arrays.asList(1, 4, 0),
			Arrays.asList(8, 5, 10), Arrays.asList(6, 89, 2));
}
